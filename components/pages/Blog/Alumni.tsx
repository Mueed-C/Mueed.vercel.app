  ...
  return (
    <div id="blog_alumni">
      <Section title="Welcome, WMC Alumni!" mbot="4" isF>
        <p className=" mt-7">
          Over here I will share and discuss various resources that may be
          useful for you all. A lot of what I will share here is what I&#39;ve
          often been asked about by my classfellows, seniors, and juniors during
          my 5 years here in Pakistan, so I know it will prove useful to some of
          you :).
        </p>
        <div id="tag_filters">
